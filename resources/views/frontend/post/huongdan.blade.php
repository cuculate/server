        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>Hướng dẫn mua hàng</span></li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div style="line-height:20px">
                        ...
                        <p><strong>Bước 1</strong>: Mẹ vào thăm Bé Yêu, chọn được sản phẩm ứng ý thì bấm vào nút
                        ...
                        <p><strong><br>Bước 6</strong>: Mẹ nhớ cung cấp đầy đủ thông tin để Bé Yêu giao hàng, gồm có:</p>
                        <p>+ Đầu tiên cần lưu ý là phải đăng nhập vào hệ thống của Bé Yêu.</p>
                        <p>+ Họ tên.</p>
                        ...
                        <div style="height:15px"></div>
                        <p><strong>Bước 7</strong>: Nếu Mẹ đã hài lòng với đơn hàng, bấm vào <strong>Đặt hàng</strong>. Bé Yêu
                            sẽ xác
