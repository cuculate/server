        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>Câu hỏi thường gặp</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="container pb-60">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <p><strong>Bé Yêu là Cửa hàng mở</strong> chuyên cung cấp những mặt hàng chính hãng đồ chơi dành cho bé,
                        những
                    ...
                    <p>Sự hài lòng của bạn là luôn tiêu chí số một của Bé Yêu.Bé Yêu hiểu rằng nhu cầu chăm sóc con của mỗi
                        gia
                    ...
                    <div style="height:15px"></div>
                    <p><span
                            style="color: #99cc00;"><strong>1. Phương thức giao nhận hàng của Bé Yêu là như thế nào?</strong></span>
                    </p>
                    <div style="height:15px"></div>
                    ...
                    <p>Nhân viên chăm sóc khách hàng của Bé Yêu sẽ liên hệ với Khách hàng qua điện thoại để xác nhận thông tin
                        đơn
                    ...
                    <div style="height:15px"></div>
                    <strong>Đối với đơn hàng có tổng giá trị thanh toán &gt;&nbsp;<strong>100.000 đồng,</strong></strong>&nbsp;Bé Yêu&nbsp;<strong>miễn
                    ...
                    <div style="height:15px"></div>
                    <p>Quý khách vui lòng gọi vào số 08 73099937 hoặc email chúng tôi tại hotro@beyeushop.com để chúng tôi có
                        thể
                    ...
                    <div style="height:15px"></div>
                    <p><span>Bé Yêu chấp nhận thanh toán trực tiếp khi nhận hàng (COD),và chuyển khoản ngân hàng.Các hình thức thanh toán khác sẽ được Bé Yêu triển khai trong thời gian tới.&nbsp;</span>
                    </p>
                    <div style="height:15px"></div>
                    ...
                    <div style="height:15px"></div>
                    <p><strong>&nbsp;Bé Yêu chấp nhận đổi trả tất cả các mặt hàng.&nbsp;</strong>Quý khách có thể đổi trả
                    ...
                    Bé Yêu giao nhầm màu (trừ trường hợp sản phẩm được ghi chú là giao màu ngẫu nhiên), nhầm size, nhầm sản
                    phẩm,
                    ...
                    <div style="height:15px"></div>
                    <p>Quý khách có thể đổi kích cỡ/màu/ kiểu nếu chọn nhầm. Bé Yêu không hoàn lại tiền cho Quý khách
                        trong
                    ...
                    <div style="height:15px"></div>
                    <p>&nbsp;Bé Yêu sẽ không hoàn lại tiền cho Quý khách trong trường hợp này.</p>
                    <p><span style="color: #99cc00;"><strong>8. Những mặt hàng nào được đổi trả?</strong></span></p>
                    <div style="height:15px"></div>
                    <p>&nbsp;Bé Yêu chấp nhận đổi trả tất cả các mặt hàng.</p>
                    <div style="height:15px"></div>
                    <p><span
                    ...
                    <div style="height:15px"></div>
                    <p><strong>Bước 1:&nbsp;</strong></p>
                    <p>Liên hệ Hotline: 08 73099937 hoặc gửi email về địa chỉ <em>hotro@beyeushop.com</em> để thông báo về yêu cầu
                        đổi, trả hàng.</p>
                    <div style="height:15px"></div>
                    <p><strong>Bước 2:&nbsp;</strong></p>
                    <div style="height:15px"></div>
                    ...
                    <p>đến địa chỉ::</p>
                    <div style="height:15px"></div>
                    Lương Quy - Xuân Nộn - Đông Anh - Hà Nội - Việt Nam.
                    <div style="height:15px"></div>
                    ...
                    <p><strong>Nếu Quý khách hàng có thêm những câu hỏi khác, xin vui lòng liên hệ Bộ phận Chăm sóc Khách hàng
                            của
                            Cửa hàng mở Bé Yêu:</strong></p>
                    <div style="height:15px"></div>
                    <p><strong>* Hotline: 08 73099937 </strong></p>
                    <div style="height:15px"></div>
                    <p><strong>* Email: <em>hotro@beyeushop.com</em> </strong></p>
                    <div style="height:15px"></div>
