        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>Chính sách đổi trả hàng</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="container pb-60">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div style="height:15px"></div>
                    Bé Yêu giao nhầm màu, nhầm size, nhầm sản phẩm, hàng hóa bị hư hỏng trong quá trình đi giao.
                    <div style="height:15px"></div>
                    ...
                    <p><span style="color: #99cc00;"><strong><em>Bước 1</em></strong>:</span> &nbsp;Khách hàng thông báo với
                        Bé Yêu về yêu cầu và nguyên nhân đổi/trả hàng thông qua các kênh hỗ trợ dưới đây trong vòng 03 ngày đầu
                        kể từ ngày nhận hàng</p>
                    <div style="height:15px"></div>
                    Hotline: 08 73099937
                    <div style="height:15px"></div>
                    Email về địa chỉ&nbsp;<em>hotro@beyeushop.com</em>&nbsp;
                    <div style="height:15px"></div>
                    ...
                    <div style="height:15px"></div>
                    <p><strong>gửi bưu điện về địa chỉ đã in trên nhãn đổi trả của Bé Yêu</strong>:</p>
                    <div style="height:15px"></div>
                    <p>Lương Quy - Xuân Nộn - Đông Anh - Hà Nội - Việt Nam.</p>
                    <div style="height:15px"></div>
                    <p>&nbsp;</p>
                    <div style="height:15px"></div>
